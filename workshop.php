...
$result = $con->prepare("SELECT * FROM event WHERE type='workshop' AND Visibility = 1 ORDER BY id DESC");
                                        $result->execute();
                ...
                <div class="content">
                  ...
                  <div class="blog">
                     <div class="container">                     
                      ...
                      <h2 class="heading text-center">Workshops</h2>
                      ...
                      <?php for($i=0; $row = $result->fetch(); $i++){?>
                        ...
                        <?php if($row['Image']!=null) { ?>					
                          <a><img style="width:550px; height:270px;" class="img-responsive sin-on" src="<?php echo $row['Image']; ?>" alt="" /></a>
                          <?php } ?>
                          <div class="blog-top">
                           <div class="top-blog">
                            ...
                            <p align="justify" class="sed">
                             <?php
                             echo substr($row['Description'], 0, 400). '...';                                             
