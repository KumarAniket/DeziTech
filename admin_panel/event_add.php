...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta charset="utf-8">
  <title>Add Events- Admin Control Panel</title>
...
<div class="container-fluid" id="main">
    <div class="row row-offcanvas row-offcanvas-left">
        <div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar" role="navigation">
            <ul class="nav nav-pills nav-stacked">                           
                ...
                <li class="nav-item"><div class="nav-link">
                <a href="event_add.php"><strong>Add Events</strong></a> </br>
        ...
        <div class="col-md-9 col-lg-10 main">
            ...
            <p class="hidden-md-up">
               ...
               <form id="add_event" action="javascript:return false" method="POST">
  ...
  <tr>
    <td>Description :</td>
    <td><textarea name="Description" required id="Description" style="width:500px; height:200px;"></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr>  
  <tr>
    <td>Link:</td>    
    <td>http://<input name="Link" id="Link"></input></td>       
  </tr> 
  <tr>
    <td>&nbsp;</td>        
  </tr>
  <tr>
    <td>Facebook Link:</td>    
    <td>http://<input name="Fb_Link" id="Fb_Link"></input></td>       
  </tr> 
  <tr>
    <td>&nbsp;</td>        
  </tr>  
  <tr>
    <td>Twitter Link:</td>    
    <td>http://<input name="Tw_Link" id="Tw_Link"></input></td>       
  </tr> 
  <tr>
    <td>&nbsp;</td>        
  </tr> 
