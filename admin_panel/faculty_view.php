...
$result = $con->prepare("SELECT * FROM `faculty`");
		         $result->execute();
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta charset="utf-8">
  <title>Edit Faculty- Admin Control Panel</title>
    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-md-9 col-lg-10 main">
           ...
           <div id="newfac" class="card">
                       ...
                       Faculties List  <input type="text" style="float:right;" name="Search" id="Search" placeholder="Enter Keyword to Search"></input>
                        </div>
	             ...
	             ?>
                                <tr id="<?php echo $row['id']; ?>">
                                    ...
                                    <td><input type="checkbox" class="checkbox" rel="<?php echo $row['id'];?>" rel2="faculty" value="1" 
                                        <?php if($row['Visibility']==1) echo 'checked'; ?>>                                          
                                        </input>
                                        <img src="../images/loading.gif" id="loading_<?php echo $row['id']; ?>" style="display:none;">
                                        </td>
                                    <td><a href="faculty_edit.php?id=<?php echo $row['id']; ?>">Edit</a></td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  ...
  <script src="js/delete_faculty.js"></script>
