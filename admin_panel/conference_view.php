...
$result = $con->prepare("SELECT * FROM event WHERE type='conference'");
		         $result->execute();
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta charset="utf-8">
  <title>Edit Conference- Admin Control Panel</title>
    ...
    <div class="row row-offcanvas row-offcanvas-left">
        <div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar" role="navigation">
            <ul class="nav nav-pills nav-stacked">                           
                ...
                <a href="event_view.php"><strong>Edit Events</strong></a>
                </div>
                </li>
        ...
        <div class="col-md-9 col-lg-10 main">
           ...
           <div id="newfac" class="card">
                       ...
                       Event Type: 
                            <select onchange="location=this.options[this.selectedIndex].value;" name="type" id="type">                            
                            <option value="conference_view.php">Conference</option> 
                            <option value="workshop_view.php">Workshop</option>      
                            <option value="others_view.php">Others</option> 
                            <option value="event_view.php">All</option> 
	             ...
	             ?>
                                <tr id="<?php echo $row['id']; ?>">
                                    ...
                                    <td><input type="checkbox" class="checkbox" rel="<?php echo $row['id'];?>" rel2="event" value="1" 
                                        <?php if($row['Visibility']==1) echo 'checked'; ?>>                                          
                                        </input>
                                        <img src="../images/loading.gif" id="loading_<?php echo $row['id']; ?>" style="display:none;">
                                        </td>
                                    <td><a href="event_edit.php?id=<?php echo $row['id']; ?>">Edit</a></td>
