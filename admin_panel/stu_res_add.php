...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta charset="utf-8">
  <title>Add Student Downloads- Admin Control Panel</title>
...
<div class="container-fluid" id="main">
    <div class="row row-offcanvas row-offcanvas-left">
        <div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar" role="navigation">
            <ul class="nav nav-pills nav-stacked">                           
                ...
                <li class="nav-item"><div class="nav-link">
                <a href="stu_res_add.php"><strong>Add Stu Download</strong></a> </br>
        ...
        <div class="col-md-9 col-lg-10 main">
            ...
            <p class="hidden-md-up">
               ...
               <form id="add_stu_res" action="javascript:return false" method="POST">
  ...
  <tr>
    ...
    <td><input name="Title" required id="Title" ></input></td>       
  </tr> 
  <tr>
    <td>&nbsp;</td>        
  </tr>   
  <tr>
    <td>Date of Issue:</td>    
    <td><input type="text" name="Date" id="Date" value="<?php echo $Date3; ?>"></input></td>       
  </tr> 
  <tr>
    <td>&nbsp;</td>        
  </tr>
  <tr>
    ...
    <td><input name="Description" id="Description" style="width:500px;"></input></td>  
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr>    
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  ...
  <script src="js/add_stu_res.js"></script>
