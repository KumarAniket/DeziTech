...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta charset="utf-8">
  <title>Add Startup- Admin Control Panel</title>
    ...
    <div class="row row-offcanvas row-offcanvas-left">
        <div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar" role="navigation">
            <ul class="nav nav-pills nav-stacked">                           
                ...
                <li class="nav-item"><div class="nav-link">
                <a href="startup_add.php"><strong>Add Startup</strong></a> </br>
        ...
        <div class="col-md-9 col-lg-10 main">
            ...
            <p class="hidden-md-up">
               ...
               <div id="newfac" class="card">
                        ...
                        <form id="add_workshop" action="javascript:return false" method="POST">
...
function readURL(input) {
  ...
  <script src="js/add_startup.js"></script>
