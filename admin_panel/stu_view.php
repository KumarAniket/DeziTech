...
$result = $con->prepare("SELECT * FROM `stu`");
		         $result->execute();
    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-md-9 col-lg-10 main">
           ...
           <div id="newfac" class="card">
                       ...
                       Student Achievments List  <input type="text" style="float:right;" name="Search" id="Search" placeholder="Enter Keyword to Search"></input>
                        </div>
	             ...
	             ?>
                                <tr id="<?php echo $row['id']; ?>">
                                    ...
                                    <td><input type="checkbox" class="checkbox" rel="<?php echo $row['id'];?>" rel2="stu" value="1" 
                                        <?php if($row['Visibility']==1) echo 'checked'; ?>>                                          
                                        </input>
                                        <img src="../images/loading.gif" id="loading_<?php echo $row['id']; ?>" style="display:none;">
                                        </td>
                                    <td><a href="stu_edit.php?id=<?php echo $row['id']; ?>">Edit</a></td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  ...
  <script src="js/delete_stu.js"></script>
