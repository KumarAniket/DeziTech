...
$query = $con->prepare("SELECT * FROM `news` WHERE id='".$_GET['id']."'");
             $query->execute();
             $row = $query->fetch();
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta charset="utf-8">
  <title>Edit News- Admin Control Panel</title>
...
<div class="container-fluid" id="main">
    <div class="row row-offcanvas row-offcanvas-left">
        <div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar" role="navigation">
            <ul class="nav nav-pills nav-stacked">                           
                ...
                <a href="news_view.php"><strong>Edit News</strong></a>
                </div>
                </li>
                <li class="nav-item"><div class="nav-link">
        ...
        <div class="col-md-9 col-lg-10 main">
            ...
            <p class="hidden-md-up">
               ...
               <form id="update_news" action="javascript:return false" method="POST">
  ...
  <tr>
    <td>Date:</td>
    <td>
   <input type="text" name="Date" id="Date" value="<?php echo $row['Date'];?>"></input></td>
    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>        
