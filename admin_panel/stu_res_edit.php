...
if ( !isset ( $_GET['id']))
 header('Location: stu_res_view.php');


$query = $con->prepare("SELECT * FROM `stu_res` WHERE id='".$_GET['id']."'");
             $query->execute();
             $row = $query->fetch();
?>
<!DOCTYPE html>
...
<div class="container-fluid" id="main">
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-md-9 col-lg-10 main">
            ...
            <p class="hidden-md-up">
               ...
               <form id="update_stu_res" action="javascript:return false" method="POST">
  ...
  <tr>
    ...
    <td><input name="Title" required id="Title" value="<?php echo $row['Title']; ?>"></input>
  ...
  <tr>
    <td>Date of Issue:</td>    
    <td><input type="text" name="Date" id="Date" value="<?php echo date("d-m-Y", strtotime($row['Date'])); ?>"></input></td>       
  </tr> 
  <tr>
    <td>&nbsp;</td>        
  </tr>
  <tr>
    ...
    <td><input name="Description" id="Description" style="width:500px;" value="<?php echo $row['Description']; ?>"></input></td>  
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr>  
  <tr>
    <td>Current Document Link :</td>
  ...
  <tr>
    <td>Upload New Doc :</td>
    <td><input type="file" name="Input" id="Input" accept=".xlsx,.xls,.doc,.docx,.ppt,.pptx,.txt,.pdf"></input></td>
    </tr>
    <tr>
    <td>&nbsp;</td>        
  </tr> 
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  ...
  <script src="js/update_stu_res.js"></script>
