...
$result = $con->prepare("SELECT * FROM `notice`");
		         $result->execute();
           ...
           <div id="newfac" class="card">
	             ...
	             ?>
                                <tr id="<?php echo $row['id']; ?>">
                                    ...
                                    <td><input type="checkbox" class="checkbox" rel="<?php echo $row['id'];?>" rel2="notice" value="1" 
                                        <?php if($row['Visibility']==1) echo 'checked'; ?>>                                          
                                        </input>
                                        <img src="../images/loading.gif" id="loading_<?php echo $row['id']; ?>" style="display:none;">
                                        </td>
                                    <td><a href="notice_edit.php?id=<?php echo $row['id']; ?>">Edit</a></td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  ...
  <script src="js/delete_notice.js"></script>  
