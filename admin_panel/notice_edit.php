...
$query = $con->prepare("SELECT * FROM `notice` WHERE id='".$_GET['id']."'");
             $query->execute();
             $row = $query->fetch();
?>
<!DOCTYPE html>
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta charset="utf-8">
  <title>Edit Notice- Admin Control Panel</title>
    ...
    <div class="row row-offcanvas row-offcanvas-left">
        <div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar" role="navigation">
            <ul class="nav nav-pills nav-stacked">                           
                ...
                <a href="notice_view.php"><strong>Edit Notice</strong></a>
                </div>
                </li>
                <li class="nav-item"><div class="nav-link">
        ...
        <div class="col-md-9 col-lg-10 main">
            ...
            <p class="hidden-md-up">
               ...
               <form id="update_notice" action="javascript:return false" method="POST">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  ...
  <script src="js/update_notice.js"></script>
