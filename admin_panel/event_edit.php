...
$query = $con->prepare("SELECT * FROM `event` WHERE id='".$_GET['id']."'");
             $query->execute();
             $row = $query->fetch();
...
<div class="container-fluid" id="main">
  ...
  <tr>
    <td>Link:</td>    
    <td><input name="Link" id="Link" value="<?php echo $row['Link']; ?>"></input></td>       
  </tr> 
  <tr>
    <td>&nbsp;</td>        
  </tr>  
  <tr>
    <td>Facebook Link:</td>    
    <td><input name="Fb_Link" id="Fb_Link" value="<?php echo $row['Fb_Link']; ?>"></input></td>       
  </tr> 
  <tr>
    <td>&nbsp;</td>        
  </tr>  
  <tr>
    <td>Twitter Link:</td>    
    <td><input name="Tw_Link" id="Tw_Link" value="<?php echo $row['Tw_Link']; ?>"></input></td>       
  </tr> 
  <tr>
    <td>&nbsp;</td>        
  </tr>    
