...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta charset="utf-8">
  <title>Add Faculty- Admin Control Panel</title>
...
<div class="container-fluid" id="main">
    <div class="row row-offcanvas row-offcanvas-left">
        <div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar" role="navigation">
            <ul class="nav nav-pills nav-stacked">                           
                ...
                <a href="faculty_add.php"><strong>Add Faculty</strong></a> </br>
        ...
        <div class="col-md-9 col-lg-10 main">
            ...
            <p class="hidden-md-up">
               ...
               <div id="newfac" class="card">
                        ...
                        <form id="add" action="javascript:return false" method="POST">
                            <table style="width:120%">
  <tr>
    <td>Name :</td>    
    <td><input name="Name" required id="Name"></input></td>       
  </tr> 
  <tr>
    <td>&nbsp;</td>        
  </tr>   
  <tr>
    <td>Designation :</td>
    <td><input name="Position" id="Position"></input></td>
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr>   
  <tr>
    <td>Cabin No :</td>
    <td><input name="Cabin" id="Cabin"></input></td>    
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr> 
  <tr>
    ...
    <div class="image-editor" id="image-editor">
      ...
      <a  href="javascript:return false" class="rotate-cw"><img src="../images/rotate.png"></a>     
  ...
  <tr>
  <td>About Faculty :</td>
  <td><textarea name="About" id="About" style="width:500px; height:100px;" placeholder="Leave it blank if nothing"></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr> 
  ...
  <td>Industry:<input style="width:50px;"type="number" name="Indus" id="Indus" value="0"></input>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Research:<input style="width:50px;"type="number" name="Resear" id="Resear" value="0"></input>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Teaching:<input style="width:50px;"type="number" name="Teach" id="Teach" value="0"></input></td>  
  </tr>
  </tr>
  <tr>
    <td>&nbsp;</td>        
  ...
  <tr>
  <td>Subjects :</td>  
  <td><textarea name="Subject" id="Subject" style="width:500px; height:100px;"></textarea>&nbsp;Separate by new line.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr> 
  ...
  <td><textarea name="Splz" id="Splz" style="width:500px; height:100px;"></textarea>&nbsp;Separate by new line.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr>
  <tr>
  <td>Achievements :</td>  
  <td><textarea name="Achiev" id="Achiev" style="width:500px; height:100px;" placeholder="Leave it blank if nothing"></textarea>&nbsp;Separate by new line.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr> 
  <tr>
  <td>Conferences :</td>  
  <td><textarea name="Conf" id="Conf" style="width:500px; height:100px;" placeholder="Leave it blank if nothing"></textarea>&nbsp;Separate by new line.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr>
  <tr>
  <td>Journals :</td>  
  <td><textarea name="Journ" id="Journ" style="width:500px; height:100px;" placeholder="Leave it blank if nothing"></textarea>&nbsp;Separate by new line.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr>
  <tr>
  <td>Projects :</td>  
  <td><textarea name="Proj" id="Proj" style="width:500px; height:100px;" placeholder="Leave it blank if nothing"></textarea>&nbsp;Separate by new line.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>        
  </tr>
