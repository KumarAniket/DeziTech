...
if ( !isset ( $_GET['id']))
 header('Location: startup_view.php');


$query = $con->prepare("SELECT * FROM `startup` WHERE id='".$_GET['id']."'");
             $query->execute();
             $row = $query->fetch();
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta charset="utf-8">
  <title>Edit Conferences- Admin Control Panel</title>
...
function readURL(input) {
  ...
  <script src="js/update_startup.js"></script>
